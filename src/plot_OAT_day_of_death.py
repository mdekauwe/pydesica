...
ax1.plot(tmp.gmin, tmp.day_of_death, color=colours[0], marker="o", ls=" ",
         label="RF", ms=3)
tmp = grw.drop_duplicates(subset='gmin')
...
tmp = grw.drop_duplicates(subset='lai')
...
tmp = grw.drop_duplicates(subset='p50')
...
ax4.plot(tmp.depth, tmp.day_of_death, color=colours[0], marker="o", ls=" ",
         ms=3)
tmp = grw.drop_duplicates(subset='depth')
...
tmp = grw.drop_duplicates(subset='Cl')
...
tmp = grw.drop_duplicates(subset='Cs')
